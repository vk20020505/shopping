    ...
    for (int i = 0; i < ShoppingCartItems.length; i++) {
      subtotal = subtotal +
          (ShoppingCartItems[i]['count'] *
              int.parse(ShoppingCartItems[i]['price']));
    }
    return subtotal;
  }
                    ...
                    child: Row(
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                              fit: BoxFit.cover,
                              image: NetworkImage(ShoppingCartItems[index]
                        ...
                        Column(
                          ...
                          children: [
                            Text(
                              ShoppingCartItems[index]['Name'] as String,
                    ...
                    child: ElevatedButton(
                        onPressed: () {
                          Navigator.push(context,
                            ...
                            return Payment(amount: total().toString(),);
                          }));
                        },
                        style: ElevatedButton.styleFrom(
